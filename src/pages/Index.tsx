    ...
    <div className="container mx-auto px-4">
      ...
      <div className="max-w-3xl mx-auto">
        <Accordion type="single" collapsible className="w-full">
          ...
          "a": "Yes, you can provide your own backdrop, props, and decorations."
        }, {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-secondary-foreground/20">
        ...
        <div>
          ...
          <nav className="space-y-3">
            ...
            <a href="/equipment" className="block text-secondary-foreground/80 hover:text-primary transition-colors">The Perfect Booth Unit</a>
            
            <a href="/join-team" className="block text-secondary-foreground/80 hover:text-primary transition-colors">Join Our Team</a>
            <a href="/vendors" className="block text-secondary-foreground/80 hover:text-primary transition-colors">Recommended Vendors</a>
          </nav>
        </div>
        ...
        <div>
          ...
          <nav className="space-y-3">
            <a href="https://www.instagram.com/perfectbooth.co/" target="_blank" rel="noreferrer" className="block text-secondary-foreground/80 hover:text-primary transition-colors">Instagram</a>
