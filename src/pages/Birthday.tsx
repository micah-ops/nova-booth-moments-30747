          ...
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible value={expandedAccordion} onValueChange={setExpandedAccordion}>
              ...
              <AccordionItem value="props">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Yes! Every booking includes a prop collection. We can also source theme-specific props to match your party, and you're welcome to provide your own props in addition to ours.
                </AccordionContent>
              </AccordionItem>
